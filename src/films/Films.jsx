...
const Films = () => {
    ...
    return (
        <>
            <div className='form'>
                <input type="text" value={filmNameField} onChange={(e) => {
                    setFilmNameField(e.target.value)
                }} />
                <input type="text" value={filmRatingField} onChange={(e) => {
                    setFilmRatingField(e.target.value)
                }} />
                <input type="text" value={filmDescriptionField} onChange={(e) => {
                    setFilmDescriptionField(e.target.value)
                }} />
                <button onClick={() => {
